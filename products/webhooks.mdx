...
<Steps>
  ...
  <Step title="Register your endpoint via the API">
    ...
    ```bash
    curl -X POST https://dev-api.onecluster.co/api/v1/collections/webhooks \
...
```bash
curl -X GET "https://dev-api.onecluster.co/api/v1/collections/webhooks/wh_abc123def456/deliveries?page=1&limit=20" \
  -H "Authorization: ApiKey ubn_sb_your_key_here"
```
...
```bash
curl -X POST https://dev-api.onecluster.co/api/v1/collections/webhooks/wh_abc123def456/deliveries/del_abc456/replay \
  -H "Authorization: ApiKey ubn_sb_your_key_here"
```
...
```bash
curl -X DELETE https://dev-api.onecluster.co/api/v1/collections/webhooks/wh_abc123def456 \
  -H "Authorization: ApiKey ubn_sb_your_key_here"
```
