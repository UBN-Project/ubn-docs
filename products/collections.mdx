...
curl -X GET "https://dev-api.onecluster.co/api/v1/collections/transactions?from=2026-03-01&to=2026-03-25&page=1&limit=50" \
  -H "Authorization: ApiKey ubn_sb_your_key_here"

# Credits for a specific account number
curl -X GET "https://dev-api.onecluster.co/api/v1/collections/transactions?accountNumber=9876543210&from=2026-03-01&to=2026-03-25" \
  -H "Authorization: ApiKey ubn_sb_your_key_here"
```
