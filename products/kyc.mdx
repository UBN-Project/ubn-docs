...
<Tabs>
  <Tab title="cURL">
    ```bash
    curl -X POST https://dev-api.onecluster.co/api/v1/kyc/bvn \
  ...
  <Tab title="JavaScript (fetch)">
    ```javascript
    const response = await fetch('https://dev-api.onecluster.co/api/v1/kyc/bvn', {
      method: 'POST',
      headers: {
...
<Tabs>
  <Tab title="cURL">
    ```bash
    curl -X POST https://dev-api.onecluster.co/api/v1/kyc/nin \
      -H "Authorization: ApiKey ubn_sb_your_key_here" \
      -H "Content-Type: application/json" \
      -d '{
        "nin": "98765432101",
  ...
  <Tab title="JavaScript (fetch)">
    ```javascript
    const response = await fetch('https://dev-api.onecluster.co/api/v1/kyc/nin', {
      method: 'POST',
      headers: {
        'Authorization': 'ApiKey ubn_sb_your_key_here',
        'Content-Type': 'application/json',
...
<Tabs>
  <Tab title="cURL">
    ```bash
    curl -X POST https://dev-api.onecluster.co/api/v1/kyc/cac \
      -H "Authorization: ApiKey ubn_sb_your_key_here" \
      -H "Content-Type: application/json" \
      -d '{
        "rcNumber": "RC1234567",
  ...
  <Tab title="JavaScript (fetch)">
    ```javascript
    const response = await fetch('https://dev-api.onecluster.co/api/v1/kyc/cac', {
      method: 'POST',
      headers: {
        'Authorization': 'ApiKey ubn_sb_your_key_here',
        'Content-Type': 'application/json',
